...
CREATE TABLE "public"."user_roles" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "user_id" character varying NOT NULL, "role_id" uuid NOT NULL, PRIMARY KEY ("id"));
