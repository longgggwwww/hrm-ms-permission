...
CREATE TABLE "public"."user_perms" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "user_id" character varying NOT NULL, "perm_id" uuid NOT NULL, PRIMARY KEY ("id"));
...
-- Create "roles" table
CREATE TABLE "public"."roles" ("id" uuid NOT NULL, "code" character varying NOT NULL, "name" character varying NOT NULL, "color" character varying NULL, "description" character varying NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "public"."user_roles" ("id" uuid NOT NULL, "user_id" character varying NOT NULL, "role_id" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "user_roles_roles_user_roles" FOREIGN KEY ("role_id") REFERENCES "public"."roles" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
